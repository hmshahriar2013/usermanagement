...
This document defines the standardized procedure for implementing features and plans in the User Management System (UMS) using agentic AI. All future implementations must adhere to this lifecycle.
...
### Step 2: Task Context
Review the atomic tasks (TASK-001, TASK-002, etc.) within the selected phase. Ensure technical requirements and constraints are understood.
